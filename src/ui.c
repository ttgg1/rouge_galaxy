...
static void drawBorders(ui_win_t* win, Image* backgroundImage)
{
	...
	(Rectangle) {
		0, 0, (float)topBottomImage.width,
		(float)topBottomImage.height
	},
	(Rectangle) {
		0, 0, (float)backgroundImage->width,
		(float)topBottomImage.height
	},
	WHITE);
	// now bottom border
	...
	(Rectangle) {
		0, ypos, (float)backgroundImage->width,
		(float)topBottomImage.height
	},
	WHITE);
